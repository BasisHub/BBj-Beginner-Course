...
- [ ] **INFRA-07**: Content reorganized into numbered chapter directories (01-, 02-, etc.)
- [ ] **INFRA-08**: Sidebar uses autogenerated categories with collapsible sections matching DWC tutorial
- [ ] **INFRA-09**: Homepage has Hero component with course title and CTA
- [ ] **INFRA-10**: Homepage has ChapterCards component showing all chapters as navigable cards
