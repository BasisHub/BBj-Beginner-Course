...
- [ ] **INFRA-01**: Site uses TypeScript configs (docusaurus.config.ts, sidebars.ts) matching DWC tutorial
- [ ] **INFRA-02**: Local search plugin installed and functional (@easyops-cn/docusaurus-search-local)
- [ ] **INFRA-03**: Mermaid diagram support enabled (@docusaurus/theme-mermaid)
- [ ] **INFRA-04**: Ideal-image plugin installed for responsive images (@docusaurus/plugin-ideal-image)
- [ ] **INFRA-05**: Image zoom plugin installed (docusaurus-plugin-zooming)
- [ ] **INFRA-06**: BBj syntax highlighting enabled via Prism (additionalLanguages includes bbj)
